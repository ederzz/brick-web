...
export default class scroll extends React.Component {
  ...
  getRatio = () => {
    ...
    this.scrollVerticalRatio = this.contentHeight ? Number((this.visibleHeight / this.contentHeight).toFixed(2)) : 1;
    ...
    this.scrollHorizontalRatio = this.contentWidth ? Number((this.visibleWidth / this.contentWidth).toFixed(2)) : 1;

    // console.log('clientWidth scrollWidth',this.visibleWidth,this.contentWidth)
  ...
  barIsHidden = () => {
    ...
    // console.log('this.scrollHorizontalRatio',this.scrollHorizontalRatio)
